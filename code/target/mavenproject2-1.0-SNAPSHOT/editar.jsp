...
<html>
    ...
    <body>
        ...
        <div class="formularioActualizar cuerpo">
...
<%
    String nom,ape,mail,tema;
       ...
       if(nom!=null && ape!=null && mail!=null && tema!=null ){
           ps=con.prepareStatement("update orador set nombre='"+nom+"', apellido='"+ape+"', mail='"+mail+"', tema='"+tema+"' where id="+id);
           ps.executeUpdate();
